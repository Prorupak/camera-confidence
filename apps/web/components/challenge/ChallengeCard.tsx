...
/** Today's Challenge presentation — see design-system.md §25. Should feel inviting, not evaluative. */
export function ChallengeCard({
  ...
  return (
    <div className="w-full rounded-lg border border-border bg-surface p-7 text-left shadow-sm">
      ...
      <p className="mb-4 text-heading-2 leading-tight font-semibold text-text-primary">
        {challenge.title}
      </p>
      <div className="mb-5 flex gap-2">
        <Badge>{challenge.durationLabel}</Badge>
      </div>
      <Link
        href={href}
